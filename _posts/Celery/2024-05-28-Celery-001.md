...
subject: "Celery"
title: "Celery 기본 사용법"
description: "Celery와 RabbitMQ로 가장 기본적인 분산 처리를 해보자!"
author: tiaz0128
permalink: /Celery/1
next_post: /Celery/2
...
[Run Redis Stack on Docker](https://redis.io/docs/latest/operate/oss_and_stack/install/install-stack/docker/) 페이지를 참고합니다. 여기에서는 `redis:alpine` 이미지를 사용하도록 하겠습니다.
