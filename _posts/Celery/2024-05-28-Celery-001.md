...
subject: "Celery"
title: "Celery 기본 사용법"
description: "Celery를 사용해 RabbitMQ에 publish / consume"
author: tiaz0128
permalink: /Celery/1
...
{% include template/github.html
  ...
  url="https://github.com/tiaz0128/celery-tutorial"
  branch="main"
%}
...
`app.task` 데코레이터를 통해 Worker가 작업을 가져올 큐를 지정할 수 있습니다. 가져온 작업을 처리 할 Worker 함수를 작성합니다. `time.sleep(5)` 함수를 통해 작업을 수행하는데 일정 시간이 필요하다고 가정하겠습니다.
