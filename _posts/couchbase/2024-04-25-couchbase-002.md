...
description: "S3 + Couchbase Analytics Links 도입기"
author: tiaz0128
...
![Analytics Links 종류](/assets/img/content/Couchbase/002/001.png){:.img-s}
...
![S3 링크 생성](/assets/img/content/Couchbase/002/002.png){:.img-s}

### 컬렉션(collection) 생성

이제 S3 버킷명과 경로값을 이용해서 컬렉션을 생성해줍니다. 그리고 특정 파일 포맷과 파일명을 지정해서 생성이 가능합니다.

![Analytics Links 컬렉션 생성](/assets/img/content/Couchbase/002/003.png){:.img-s}
...
![S3 파일 업로드](/assets/img/content/Couchbase/002/004.png){:.img-s}
