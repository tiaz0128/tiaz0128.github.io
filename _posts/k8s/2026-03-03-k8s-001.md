...
ref-link:
  - type: url
    url: https://www.skilleat.com/shop_view/?idx=13
    title: 스킬잇 - 쿠버네티스 풀코스 15일 완주 세트 (감테크)
  - type: url
    url: https://www.udemy.com/course/certified-kubernetes-administrator-with-practice-tests/
    title: Udemy - CKA with Practice Tests (Mumshad Mannambeth)
  - type: url
    url: https://inf.run/snBHs
    title: 인프런 - CKA - Practical Exam Guide (일프로)
  - type: youtube
    url: https://www.youtube.com/watch?v=CUIc2FQ6meA&list=PLApuRlvrZKog_FwzGY0OZrMMyHcgHqYTL
    title: '따베런 - [CKA 기출문제 핵심 요약] CKA 기출문제 풀이_FULL 버전'
  - type: youtube
    url: https://youtu.be/rP-W3Tv3plw?si=3u7rlre-d1CmteT7
    title: Easy CKA Exam Tasks For Beginners! | Full Solutions & Walkthrough
---
...
- [Certified Kubernetes Administrator (CKA)](https://training.linuxfoundation.org/certification/certified-kubernetes-administrator-cka/){:target="_blank"}
  - **가장 많이 따는 자격증**
  - kubernetes 관리자 역할
  - 2025년 2월 이후에 변경 사항이 많기에 최신 정보를 위주로 찾아보고 준비하자
- [Certified Kubernetes Application Developer (CKAD)](https://training.linuxfoundation.org/certification/certified-kubernetes-application-developer-ckad/){:target="_blank"}
  - kubernetes 환경에서 개발자 역할
  - CKA와 유사하거나 좀더 쉬운? 난이도
- [Certified Kubernetes Security Specialist (CKS)](https://training.linuxfoundation.org/certification/certified-kubernetes-security-specialist/){:target="_blank"}
  - kubernetes 보안 관련
  - 가장 고난도 자격증
  - CKA가 있어야 응시 가능하다
...
3. 실전 문제: [인프런 - CKA - Practical Exam Guide (일프로)](https://inf.run/snBHs){:target="_blank"}
4. CKAD 공부
  - CKA를 준비하면 충분히 가능하다
  - 같은 주제도 많고, 출제 조금 범위가 다를뿐
  - [Udemy - CKAD with Practice Tests (Mumshad Mannambeth)]( https://www.udemy.com/course/certified-kubernetes-application-developer/){:target="_blank"}
...
- 시험 등록하면 [killer.sh](https://killer.sh/){:target="_blank" .none} 2번까지 실습이 활성화 된다
