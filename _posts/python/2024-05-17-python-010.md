...
subject: "python"
title: "파이썬 쓰레드"
subtitle: "쓰레드(Thread)에 대해 알아보고 파이썬에서 쓰레드를 사용해봅시다."
author: tiaz0128
permalink: /python/10
tags: [python, 쓰레드]
mermaid: true
...
![크롬 탭](/assets/img/content/python/010/002.png){:.img-m}
...
2. monitor에서 work_thread.is_alive()를 통해 work_thread가 동작 중인지 확인 합니다.
