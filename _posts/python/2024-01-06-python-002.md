...
UTC 시간을 사용하여 데이터 통신을 하는 경우 반드시 **표준을 준수하는 형태의 시간대 문자열을 사용**{:.strong-color} 해야 혼동이 없습니다. 또한 시간을 계산할 때는 해당하는 시간의 시간대를 확인하고 그에 따른 알맞은 함수를 써서 **시간대에 따른 오차가 없도록**{:.strong-color}  해야 합니다.
