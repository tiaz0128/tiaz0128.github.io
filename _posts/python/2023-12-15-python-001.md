...
UTC 는 시간을 국제 표준시이며, 많은 시스템과 프로그래밍에서도 이를 사용하고 활용하고 있습니다. UTC 를 정확하게 표기 하기 위해서는 **ISO 8601** 를 따르면 됩니다. 하지만 위에서 출력된 결과는 어떤가요? **위에서 봤던 코드에는 함정이 있습니다.**{:.orange} 다시 한번 잘 보시길 바랍니다.
