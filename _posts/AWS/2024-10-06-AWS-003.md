...
subject: "VPC"
title: "AWS 네트워크 기본"
description: "그림으로 알아보는 AWS 네트워크 기본"
author: tiaz0128
permalink: /AWS/3
math: true
tags: [AWS, VPC, CIDR]
...
![Availability Zone](/assets/img/content/AWS/003/009.png){:.img-m}
<p class="flex">
  <a class="img-caption-a" target="_blank" href="https://docs.aws.amazon.com/ram/latest/userguide/working-with-az-ids.html">출처: Availability Zone IDs for your AWS resources</a>
</p>
