...
![Watchtower](/assets/img/content/AWS/003/004.png){:.img-200x200}
...
빌드한 이미지를 도커 허브에 _push_ 하고 빌드된 이미지를 AWS EC2에 처음에는 수동으로 배포해보고, Watchtower를 이용하여 자동으로 배포까지 해보았습니다. 다만 이 방식도 몇가지 문제점이 존재했습니다.
