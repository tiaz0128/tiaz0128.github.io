...
실제 환경에서는 두 방식을 혼합해서 사용합니다. AWS에서 EC2 서버에 SSH(22)로 접속 예를 들어 볼까요? EC2를 생성하면서 키도 생성합니다. 여기서 만들어지는 키는 비대칭키 입니다.
