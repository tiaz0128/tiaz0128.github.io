...
sub_title: "WSL2 를 이용해서 개발 환경 구축하는 방법"
author: tiaz
permalink: /tool/1
tags: [WSL, ubuntu]
---
...
[🔗 statcounter - Desktop Operating System Market Share Worldwide](https://gs.statcounter.com/os-market-share/desktop/worldwide){:.img-caption-a}{:target="_blank"}
...
[🔗 Extension: WSL](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-wsl){:.img-caption-a}{:target="_blank"}
