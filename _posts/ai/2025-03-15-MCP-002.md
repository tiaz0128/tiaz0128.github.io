...
![Cursor MCP](/assets/img/content/ai/002/002_2.png){:.img-m}
...
![Smithery](/assets/img/content/ai/002/003.png){:.img-m}

### GitHub MCP Server

Smithery에서 GitHub로 검색하면 `@smithery-ai/github`의 GitHub를 클릭합니다.

![GitHub MCP Server](/assets/img/content/ai/002/004.png)
...
![Smithery install](/assets/img/content/ai/002/006_2.png){:.img-m}
...
![Add MCP Server](/assets/img/content/ai/002/010.png){:.img-m}
...
{% include template/alert.html
  type="caution"
  about="MCP는 Anthropic 모델에만 지원합니다. 따라서 Cursor에서 Claude 모델을 선택해야 합니다!"
%}

이제 Cursor에게 GitHub 관련된 작업을 시킬 수 있습니다. Cursor가 필요한 동작을 수행 할 수 있게 `Run tool`, `Accept`만 해주면 됩니다!

![Cursor MCP GitHub](/assets/img/content/ai/002/008.png){:.img-m}
